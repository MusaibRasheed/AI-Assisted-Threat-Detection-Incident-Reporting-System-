...
axios.defaults.baseURL = 'https://ai-assisted-threat-detection-incident-pb5x.onrender.com';
import { 
...
function App() {
  ...
  useEffect(() => {
    const ws = new WebSocket('wss://ai-assisted-threat-detection-incident-pb5x.onrender.com/api/ws/alerts');
    ws.onmessage = (event) => {
       try {
